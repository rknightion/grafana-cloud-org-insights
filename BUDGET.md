...
| `gcinsight_coverage_technology_stacks` | K | `kind`(58) | 58 | 1 | one bounded registry enum per technology; value is measured stacks present |
...
| `coverage_technology_register` | K | 15,718 | 1 | stack x technology is current-state identity detail, not a time series |
