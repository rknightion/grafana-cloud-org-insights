...
CATALOGUE: tuple[MetricSpec, ...] = (
    ...
    MetricSpec("insights_query_mix", "J", store="view",
               note="top 20 datasource types and panel plugins per stack, plus one remainder row"),
    MetricSpec("coverage_producing_signals", "A", store="view",
               note="documented Metrics and Traces backend production over the prior 24 hours"),
